...
ROLE="Owner"
SCOPE="/subscriptions/d31507f4-324c-4bd1-abe1-5cdf45cba77d"  # Get the current subscription ID
GITHUB_NAME="VictortheGreat7" # Change this to your GitHub username
GITHUB_REPO="capstone_demo"
CREDENTIALS=$(cat <<EOF
{
    "name": "GitHubActions",
...
echo "Terraform variables file updated."
